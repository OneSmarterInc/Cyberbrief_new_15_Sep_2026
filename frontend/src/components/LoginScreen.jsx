...
export default function LoginScreen({ onLogin, onBack }) {
  ...
  return (
    <div className="auth-page">
      <style>{`
        .auth-page { display: flex; align-items: center; justify-content: center; min-height: 100vh; background-color: #F3EEE3; font-family: Arial, Helvetica, sans-serif; padding: 20px; }
