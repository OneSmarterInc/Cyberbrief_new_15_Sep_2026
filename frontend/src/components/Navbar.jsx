  ...
  return (
    <header className="aggregate-clone">
      <style>{`
        ...
        .aggregate-logo-img { width: clamp(38px, 6vw, 75px); height: clamp(38px, 6vw, 75px); object-fit: contain; border-radius: 7px; }
      ...
      <div className="aggregate-topbar">
        ...
        <div className="aggregate-top-right">
          <a className="aggregate-top-link" href="/how" onClick={(e) => handleNavClick(e, "/how", onAbout)}>About the Cyberbrief</a>
